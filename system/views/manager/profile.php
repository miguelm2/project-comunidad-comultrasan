                  ...
                  <form method="post">
                     <div class="row">
                        <div class="col-md-4 text-center mx-auto mb-3">
                           <img src="<?= Path::$DIR_IMAGE_MANAGER . $_SESSION['imagen'] ?>" alt="" class="img-fluid" style="max-height: 70%;">
                        </div>
                        <div class="col-md-8">
                           <div class="row">
                              <div class="col-12">
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control border p-1" name="nombre" maxlength="255" value="<?= $_SESSION['nombre'] ?>" required>
                              ...
                              <div class="col-12">
                                 <div class="form-group">
                                    ...
                                    <input type="email" class="form-control border p-1" name="correo" maxlength="255" value="<?= $_SESSION['correo'] ?>" required>
                                 </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <label class="form-label">Celular</label>
                                    <input type="text" class="form-control border p-1" name="telefono" value="<?= $_SESSION['telefono'] ?>" required>
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label for="" class="form-label">Cedula</label><br>
                                    <input type="text" class="form-control border p-1" name="cedula" maxlength="30" value="<?= $_SESSION['cedula'] ?>">
                                 </div>
                              </div>
                              <div>
                     ...
                     <div class="row mt-4">
                        ...
                        <div class="col-md-4 d-grid">
                           <button type="submit" class="btn btn-success" name="setProfileManager">
                              <i class="material-icons me-2">save</i> Guardar Información</button>
                        </div>
                        <div class="col-md-4 d-grid">
            ...
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <div class="form-group">
                        <label class="form-label" for="imageManager">Imagen</label>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="submit" name="setImgeManagerProfile" class="btn btn-info">
