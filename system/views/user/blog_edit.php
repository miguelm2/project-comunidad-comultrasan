                        ...
                        <form method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" placeholder="Contenido" name="contenido" required id="texto"><?= $blog->getContenido() ?></textarea>
                                </div>
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="modal fade" id="modalActualizar" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="p-4">
                            <div style="background-image: url(../../img/blog/<?= $blog->getImagen(); ?>);width: 100%;height:0;padding-top:50%; background-position: 50% 50%; background-size: cover;border-radius:10px">
                            </div>
                        </div>
                        <div class="modal-header">
