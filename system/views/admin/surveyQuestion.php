      ...
      <div class="pagetitle p-1 mt-2 mp-0">
         <nav>
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item"><a href="survey?survey=<?= $_GET['survey'] ?>">Encuesta</a></li>
         ...
         <div class="modal fade" id="newQuestion" tabindex="-1">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <div class="modal-footer">
                     <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="material-icons me-2">close</i> Cerrar</button>
                     <button type="submit" name="newAnswerQuestion" class="btn btn-success"><i class="material-icons me-2">add</i> Nueva Pregunta</button>
                  </div>
               </div>
            </div>
         </div>
