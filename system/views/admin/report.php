            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="text-primary">Reporte Información Empresa</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body" style="padding-top: 5px;">
                        ...
                        <form class="row g-3" method="post">
                            <div class="col-md-12 d-grid gap-2 mt-3">
                                <button type="submit" class="btn btn-primary" name="getReportInformation"><i class="bi bi-filetype-pdf"></i> Generar Reporte</button>
                            </div>
                        </form><!-- Vertical Form -->
                    </div>
                </div>
