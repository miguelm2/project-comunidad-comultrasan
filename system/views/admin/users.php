                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-3 text-right d-grid">
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#newUsuario"><i class="bi bi-person-plus"></i> Nuevo Usuario</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="newUser" class="btn btn-success"><i class="bi bi-plus-square"></i> Nuevo Usuario</button>
                        </div>
                    </div>
                </div>
            </div>
