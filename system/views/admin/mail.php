			...
			<div class="row">
				<div class="card">
					<div class="card-header">
						<div class="row">
							<div class="col-md-10">
								<h5 class="text-primary">Enviar correo</h5>
							</div>
						</div>
					</div>
					<div class="card-body" style="padding: 3%;">
						...
						<form method="post" enctype="multipart/form-data">
							...
							<div class="row g-2">
								...
								<div class="col-md-12">
									<label for="form-label">Para</label>
									<input type="email" class="form-control" placeholder="Para" name="para" required>
								</div>

								<div class="col-md-12">
									<label for="form-label">Asunto</label>
									<input type="text" class="form-control" placeholder="Asunto" name="asunto" required>
								</div>
								
								<div class="col-md-12">
									<label for="form-label">Contenido</label>
									<textarea class="form-control" placeholder="Contenido" name="contenido" id="texto" required>Contenido</textarea>
								</div>

								<div class="col-sm" style="text-align: center;">
									<button type="submit" class="btn btn-primary col-md-3" name="sendMail"><i class="bi bi-send-check"></i> Enviar</button>
								</div>
