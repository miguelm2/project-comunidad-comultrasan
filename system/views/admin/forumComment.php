         ...
         <div class="container-fluid">
            <nav aria-label="breadcrumb" class="d-none d-lg-block">
               <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                  ...
                  <li class="breadcrumb-item"><a href="typeComunities" class="text-white">Tipo de comunidad</a></li>
               ...
               <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                        ...
                        <button type="submit" name="deleteForumCommentAdmin" class="btn btn-danger"><i class="material-icons me-2">delete</i> Eliminar Comentario</button>
                     </div>
                  </div>
               </div>
            </div>
