         ...
         <div class="container-fluid">
            <nav aria-label="breadcrumb" class="d-none d-lg-block">
               <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                  ...
                  <li class="breadcrumb-item active">Beneficios Página</li>
               </ol>
            </nav>
         </div>
         <!-- Start header -->
      ...
      <div class="card">
         <div class="row m-0">
            <div class="col-md-8 m-4">
               <div class="card-head">
                  <h4 class="text-success">Beneficios Página</h4>
               </div>
            </div>
         ...
         <div class="card-body m-0">
            <div class="table-responsive">
               <table class="table table-bordered table-hover align-items-center mb-0" id="tableBenefitPage">
