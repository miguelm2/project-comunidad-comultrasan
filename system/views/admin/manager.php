                        ...
                        <div class="row">
                           <div class="col-12">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control border p-1" value="<?= $manager->getNombre() ?>" name="nombre" required>
                              </div>
                           </div>
                           <div class="col-6">
                              <div class="form-group">
                                 <label class="form-label">Cédula</label>
                                 <input type="number" class="form-control border p-1" value="<?= $manager->getCedula() ?>" name="cedula" required>
                              </div>
                           </div>
                           <div class="col-6">
                              <div class="form-group">
                                 <label class="form-label">Celular</label>
                                 <input type="tel" class="form-control border p-1" value="<?= $manager->getTelefono() ?>" name="telefono" required>
                              </div>
                           </div>
                           <div class="col-6">
                              <div class="form-group">
                                 <label class="form-label">Correo</label>
                                 <input type="email" class="form-control border p-1" value="<?= $manager->getCorreo() ?>" name="correo" required>
                              </div>
                           </div>
                           <div class="col-6">
                              <div class="form-group">
            ...
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="submit" name="deleteQuestion" class="btn btn-danger"><i class="material-icons me-2">delete</i> Eliminar Gestor</button>
                  </div>
               </div>
            </div>
         </div>
