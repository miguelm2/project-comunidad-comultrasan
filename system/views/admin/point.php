         ...
         <div class="container-fluid">
            <nav aria-label="breadcrumb" class="d-none d-lg-block">
               <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                  ...
                  <li class="breadcrumb-item"><a href="points" class="text-white">Corazones</a></li>
                  <li class="breadcrumb-item active">Editar Corazones</li>
               </ol>
            </nav>
         </div>
         <!-- Start header -->
               ...
               <div class="row">
                  ...
                  <div class="col-md-2 mt-0">
                     <div class="text-right"> <!-- Añadí 'text-right' para alinear el botón a la derecha -->
                        <a type="button" class="btn btn-secondary" href="points">
                  ...
                  <div class="row">
                     <div class="col-12">
                        <div class="form-group">
                           ...
                           <input type="number" class="form-control border p-1" name="puntos" value="<?= $points->getPuntos() ?>" required>
                        </div>
                     </div>
                     <div class="col-12">
                        <div class="form-group">
                     ...
                     <div class="col-md-6 d-grid mt-4">
                        <button type="submit" class="btn btn-success" name="setPoint">
                           <i class="material-icons me-2">edit</i> Editar Corazones
                        </button>
                     </div>
                  </div>
               </form>
            ...
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title">Eliminar Corazones</h5>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="submit" name="deletePoint" class="btn btn-danger"><i class="material-icons me-2">delete</i> Eliminar Corazones</button>
                  </div>
               </div>
            </div>
         </div>
