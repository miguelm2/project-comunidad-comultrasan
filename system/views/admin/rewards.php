      ...
      <div class="card mt-2">
         <div class="row m-0">
            <div class="col-md-8 m-4">
               <div class="card-head">
                  <h4 class="text-success">Recompensas</h4>
               </div>
            </div>
            <div class="col-md-3 m-2 mt-3">
               <div class="card-head text-right">
                  <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#newBenefit">
                     <i class="material-icons me-2">add</i> Agregar Recompensa
                  </button>
               </div>
            </div>
         </div>
            ...
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  <div class="modal-header">
                     <h5 class="modal-title">Nueva Recompensa</h5>
                  ...
                  <div class="modal-body">
                     <div class="row g-3">
                        <div class="col-md-12 form-group">
                           ...
                           <input type="text" class="form-control border p-1" name="actividad" placeholder="Actividad" maxlength="255" required>
                        </div>
                        <div class="col-md-12 form-group">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="submit" name="newReward" class="btn btn-success"><i class="material-icons me-2">add</i> Nueva Recompensa</button>
                  </div>
               </div>
            </div>
         </div>
