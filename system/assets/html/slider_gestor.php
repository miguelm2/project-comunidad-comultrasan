<aside class="sidenav navbar navbar-vertical slidenav-gestor navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main">
   <div class="sidenav-header">
      <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <a class="navbar-brand m-0" href="index">
         <img src="/assets/image/favicon_0.ico" class="navbar-brand-img h-100" alt="main_logo" width="40px">
      ...
      <ul class="navbar-nav">
         ...
         <li class="nav-item">
            <a class="nav-link text-white " href="communities">
               ...
               <span class="nav-link-text ms-1">Comunidad</span>
            </a>
         </li>
         <li class="nav-item">
         ...
         <li class="nav-item">
            <a class="nav-link text-white " href="benefits_page">
               <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
