<aside class="sidenav navbar navbar-vertical navbar-expand-xs slidenav-admin border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-faded-success" id="sidenav-main">
