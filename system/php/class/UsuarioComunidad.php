...
{
    public static function newUserCommunity($id_usuario, $id_comunidad, $fecha_registro)
    {
        $dbh  = parent::Conexion();
        $stmt = $dbh->prepare("INSERT INTO UsuarioComunidad (id_usuario, id_comunidad, fecha_registro) 
                                VALUES (:id_usuario, :id_comunidad, :fecha_registro)");
    ...
    public static function getUserCommunityByCommunity($id_comunidad)
    {
        ...
        foreach ($modalResponse as $response) {
            ...
            $UsuarioComunidadDTO->setUsuarioDTO(Usuario::getUserById('id_usuario'));
    ...
    {
        $dbh             = parent::Conexion();
        $stmt = $dbh->prepare("DELETE FROM UsuarioComunidad WHERE id_usuario_comunidad = :id_usuario_comunidad");
