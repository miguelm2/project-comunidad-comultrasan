         ...
         <div class="container">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Aguinaldos</li>
               </ol>
            </nav>
            <div class="row gy-2 align-items-center">
               <div class="col-md-12">
                  <div class="text-start">
                     <h2 class="text-pri">Aguinaldos</h2>
                     <h5 class="text-black">
                        Con cada aguinaldo, no solo compartimos alegría y buenos deseos, sino que también cultivamos la
                        costumbre de pensar en los demás y en el bienestar colectivo. Nuestra celebración de los aguinaldos
                        navideños está acompañada con la entrega de regalos como un reflejo del amor y la unidad que
                        deseamos para nuestras comunidades, manteniendo viva la magia de la Navidad en cada corazón.
                     </h5>
                  </div>
               </div>
               <div class="col-md-4">
