               ...
               <div class="row gy-2 align-items-center">
                  ...
                  <div class="col-lg-9">
                     <div class="text-center">
                        <h3>Comparte tus gustos e intereses con integrantes de otras comunidades</h3>
                     </div>
                     <div class="position-relative">
                        <h2 class="text-primary">¡Imagina un lugar donde tus pasiones se recompensan y tus intereses te conectan con otros!</h2>
         ...
         <div class="container mt-2 p-2">
            <div class="row">
               <div class="section-header pb-0">
                  <h2 class="text-black">Novedades de nuestra comunidad</h2>
               </div>
            </div>
