      ...
      <div class="container position-relative ">
         <div class="row gy-5" data-aos="fade-in">
            <div class="col-lg-7 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
               <h3 class="text-black">
                  <i>
                     ¡Bienvenido a nuestra comunidad! Aquí encontrarás un
                     mundo de oportunidades para crecer, aprender y disfrutar. <br>
                     ¡Aprovéchalos!
                  </i>
               </h3>
            ...
            <div class="col-lg-5 order-1 order-lg-2">
               <img src="assets/image/Familia-moderna.png" class="img-fluid rounded-2" alt="" data-aos="zoom-out" data-aos-delay="100">
            </div>
         </div>
      </div>
            ...
            <div class="row gy-4 mt-5">
               ...
               <div class="col-2 col-md-2" data-aos="fade-up" data-aos-delay="300">
                  <div class="icon-box">
                     ...
                     <p class="text-black">Interactúa con personas que tienen tus mismos intereses.</p>
                  </div>
               </div><!--End Icon Box -->
            </div>
         </div>
