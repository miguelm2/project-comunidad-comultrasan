         ...
         <div class="container">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Día Saludable</li>
               </ol>
            </nav>
            <div class="row gy-2 align-items-center">
               <div class="col-md-12">
                  <div class="text-start">
                     <h2 class="text-pri">Día Saludable</h2>
                     <h5 class="text-black">
                        Practicar deporte en familia no solo nos une, también sirve de ejemplo para que los más pequeños lo
                        incorporen en su vida de forma natural, estas sencillas experiencias les ayudarán a forjar las bases de una
                        vida saludable, tanto física como mentalmente. <br>
                        En este evento masivo realizaremos actividades como:
                        <div class="row">
                           <div class="col-md-6">
                              <ul>
                                 <li>
                                 ...
                                 <li>
                                    Pistas de obstáculos para niños.
                                 </li>
                                 <li>
                                    Torneos relámpagos.
                                 </li>
               ...
               <div class="col-md-4">
                  <img src="assets/image/familia_ejercicio.jpg" alt="Pioneros" class="img-fluid">
               </div>
               <div class="col-md-8">
                  <div class="text-start">
